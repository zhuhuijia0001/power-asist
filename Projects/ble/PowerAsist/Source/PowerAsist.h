...
// Power asist Task Events
#define POWERASIST_START_DEVICE_EVT         (1 << 0)
#define POWERASIST_ADV_IN_CONNECTION_EVT    (1 << 1)

#define POWERASIST_FIRST_TIMERID            8
#define POWERASIST_MAX_TIMER                8

//ble status
#define BLE_STATUS_INIT                     0
#define BLE_STATUS_ADVERTISING              1
#define BLE_STATUS_CONNECTED                2
#define BLE_STATUS_DISCONNECTED             3
 ...
 */
extern void PowerAsist_Init( uint8 task_id );

/*
 * Task Event Processor for the BLE Application
 */
extern uint16 PowerAsist_ProcessEvent( uint8 task_id, uint16 events );
